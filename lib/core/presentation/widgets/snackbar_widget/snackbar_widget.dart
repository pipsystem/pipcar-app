...
import '../../../../common/configs/constants/icon_constants.dart';
...
class TopSnackBar<T extends Object> extends StatefulWidget {
  ...
  TopSnackBar({Key? key, this.context, this.title, this.type = SnackBarType.error}) : super(key: key) {
  ...
  Future<T?> show(BuildContext context) async {
    ...
    return Navigator.of(context, rootNavigator: false).push(_topSnackBarRoute as Route<T>);
  }
...
class _TopSnackBarState<K extends Object> extends State<TopSnackBar> with TickerProviderStateMixin {
  ...
  Widget _buildIcon() {
    ...
    } else if (widget.type == SnackBarType.internetConnected) {
      return Container(
          key: const Key('internet_container_icon_key'),
          child: Icon(
            Icons.wifi,
